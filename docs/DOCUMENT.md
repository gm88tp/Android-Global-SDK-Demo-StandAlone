# GM88 Android海外游戏1.1版本单机SDK 对接文档
...
1）请修改gmsdk标签内的 appId参数，为运营提供的游戏id, appReleaseId参数为运营提供的发布记录id
...
```
**请注意，请将facebook_app_id, 替换为运营提供的id, fb_login_protocol_scheme内的fb开头须保留**
